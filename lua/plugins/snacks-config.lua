...
vim.keymap.set("n", "<leader>d/", function() snacks.picker.grep({ dirs = { vim.fn.expand("%:p:h") } }) end, { desc = "Live Grep in the buffer directory" })
vim.keymap.set({ "n", "x" }, "<leader>sw", function() snacks.picker.grep_word() end, { desc = "Live Grep (word/selection)" })
